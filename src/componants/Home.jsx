...
useEffect(()=>{
  ...
  <div class="md:col-span-8 col-span-12 mx-auto mx:mx-0">
  <div className="grid md:grid-cols-2 grid-cols-1  gap-4 px-6 md:px-4 lg:px-48">
  {data.map((service,id) => {
    return (
      <>
      ...
      <div className="grid grid-cols-2 px-4 pt-3 pb-4">
        ...
        <button class="bg-gradient-to-r  from-blue-400 to-indigo-400 hover:from-indigo-400 hover:to-blue-400   text-white font-semibold py-2 px-4 md:px-0 lg:px-4 rounded" onClick={()=> send(service)}>Add to Cart</button>
      </div>
     </div>
     </>
        )
  ...
  <p className='text-start text-2xl mb-4 font-sans font-bolder md:ml-0 ml-6 md:mt-0 mt-6'>Save cart</p>
  {
    getdata.length == 0 ? "No data found" : 
      ...
      getdata.map((e)=>{
        return (
          <>
            <div className="md:max-w-sm mx-6 shadow  bg-gray-200  shadow-md rounded-lg mb-4">
       ...
       <p className='text-xl font-semibold font-sans ml-4 pt-4'>Fruit Name: {e.name}</p>
        ...
        <div className='md:max-w-sm mx-6 shadow  bg-gray-200  shadow-md rounded-lg mt-4'>
  <div className="grid grid-cols-2 px-4 pt-3 pb-4">
  ...
  <div className='w-24 shadow  bg-gray-200  shadow-md rounded-lg mt-4 mb-4 lg:ml-72 md:ml-32 ml-56'>
